export default class Select {
  constructor(element) {
    ...
    this.options = getFormattedOptionsSelect(
  ...
  selectValue(value) {
    ...
    this.labelElement.innerHTML = newSelectedOption.label;
...
function setupSelect(select) {
  ...
  select.labelElement.classList.add("custom-select-label");
...
function getFormattedOptionsSelect(optionsElement) {
